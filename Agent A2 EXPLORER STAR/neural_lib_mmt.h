...
#define N_HID   41       //   41  NEURONAS ESCONlDIDAS
#define N_OUT   9        // NEURONAS SALIDAS 
 
//   Brand new copy Augost 12, 2018 
//=======================================================================================================================
...
float Entrada[N_IN];     
//-------------------------
float  net_1_hid[N_HID][N_IN];
float  net_1_out[N_OUT][N_HID];   

float  net_2_hid[N_HID][N_IN];
float  net_2_out[N_OUT][N_HID];   
